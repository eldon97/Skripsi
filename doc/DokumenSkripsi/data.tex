...
Salah satu cara untuk melakukan \textit{privacy-preserving data mining} adalah mengacak data menggunakan metode \textit{Randomization}. Pada penelitian ini akan dibangun sebuah perangkat lunak yang mengimplementasikan teknik \textit{Random Rotation Perturbation} dan \textit{Random Projection Perturbation}. Berdasarkan hasil eksperimen, teknik \textit{Random Rotation Perturbation} dan \textit{Random Projection Perturbation} dapat digunakan pada \textit{dataset} yang akan digunakan untuk penambangan data klasifikasi dengan algoritma \textit{k-nearest neighbors} dan penambangan data \textit{clustering} dengan algoritma \textit{k-means}. Model penambangan data yang dilatih dengan \textit{dataset} asli dan \textit{dataset} yang telah diacak dengan kedua teknik tersebut memiliki kualitas yang sama atau sangat mirip.}
\abstrakENG{In the data mining process, the data used is often given to other parties and there is potential for privacy in the data is spread to unauthorized parties. The privacy data can be spread to irresponsible and misused parties. In avoiding this, privacy-preserving data mining needs to be done. Privacy can be said is a person's personal information that can identify a thing in that person. The concept that is often used to describe personal information is Personally Identifiable Information, abbreviated PII. PII is all information about an individual that is managed by an agency, including all information that can be used to distinguish or investigate a person's identity and also all information related to or can be linked to an individual, such as medical, educational, financial, and job information.

One way to do privacy-preserving data mining is to randomize data using the Randomization method. In this study software will be built that implements Random Rotation Perturbation and Random Projection Perturbation techniques. Based on the experimental results, the Random Rotation Perturbation and Random Projection Perturbation techniques can be used to a \textit{dataset} that will be used for classification data mining with the k-nearest neighbors algorithm and clustering data mining with the k-means algorithm. Data mining models that are trained with the original dataset and the dataset that have been randomized with both techniques have the same or very similar quality.} 
%=============================================================================

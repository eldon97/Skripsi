...
\begin{enumerate}
    \item Penelitian ini hanya menguji apakah \textit{dataset} yang telah diacak dapat digunakan untuk penambangan data dan menghasilkan kualitas yang sama atau mendekati aslinya.
    \item Penelitian ini tidak menguji kualitas privasi yang hilang atau apakah ada potensi \textit{dataset} yang telah diacak dapat dikembalikan ke aslinya.
    \item Penelitian ini hanya menguji dengan teknik penambangan data tertentu dengan metode tertentu dan menggunakan data tertentu saja yang telah dipilih.

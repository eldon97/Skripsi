...
\subsection{Teknik \textit{Random Rotation Perturbation} dengan teknik penambangan data \textit{K-Nearest Neighbors}}
\label{sec:rrp-knn}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.15]{pairplot_mall_customers}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{siluet_mall_customers}

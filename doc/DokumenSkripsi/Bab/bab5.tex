...
\noindent\begin{minipage}{.46\textwidth}
	\begin{lstlisting}[caption=Akurasi \textit{Dataset} Asli,frame=tlrb, label=diabetes_akurasi_asli]{Name}
...
\begin{minipage}{.46\textwidth}
	\begin{lstlisting}[caption=Akurasi \textit{Dataset} Teracak,frame=tlrb, label=diabetes_akurasi_randomisasi]{Name}
...
\noindent\begin{minipage}{.46\textwidth}
	\begin{lstlisting}[caption=Akurasi \textit{Dataset} Asli,frame=tlrb, label=mobile_sensor_akurasi_asli]{Name}
Akurasi setiap K pada 
training set dataset asli: 
...
23: 0.9046487953851374
	...
	\end{minipage}\hfill
	\begin{minipage}{.46\textwidth}
	\begin{lstlisting}[caption=Akurasi \textit{Dataset} Teracak,frame=tlrb, label=mobile_sensor_akurasi_randomisasi]{Name}
Akurasi setiap K pada training 
set dataset teracak: 

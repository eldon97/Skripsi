...
\textit{Adjusted Rand Index} adalah metode untuk menghitung kemiripan dari sebuah model \textit{clustering} dengan model \textit{clustering} lainnya. Nilai dari \textit{Adjusted Rand Index} menunjukkan kemiripan anggota \textit{cluster-cluster} yang ada pada dua model \textit{clustering} yang ingin dibandingkan. Rumus untuk menghitung nilai \textit{Adjusted Rand Index} dapat dilihat pada Persamaan.

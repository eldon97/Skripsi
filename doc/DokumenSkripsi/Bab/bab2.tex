...
Ide utama dari teknik \textit{Random Rotation Perturbation} adalah jika data direpresentasikan sebagai matrix Xd*n, \textit{rotation perturbation} dari datasest X didefinisikan sebagai G(x)=RX. Dimana Rd*d adalah \textit{random rotation othonormal matrix}.
